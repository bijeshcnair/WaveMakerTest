...
import com.testloginapp.hoursaccont1.service.LoginService;
 ...
 * @see Login
 */
@RestController("HoursAccOnt1.LoginController")
@Api(value = "LoginController", description = "Exposes APIs to work with Login resource.")
@RequestMapping("/HoursAccOnt1/Login")
public class LoginController {

    private static final Logger LOGGER = LoggerFactory.getLogger(LoginController.class);

    @Autowired
	@Qualifier("HoursAccOnt1.LoginService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Login editLogin(@PathVariable("id") Integer id, @RequestBody Login login) throws EntityNotFoundException {
	...
	@ApiOperation(value = "Returns the total count of Login instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
