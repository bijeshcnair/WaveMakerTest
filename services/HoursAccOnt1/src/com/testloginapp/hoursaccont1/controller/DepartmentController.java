...
import com.testloginapp.hoursaccont1.service.DepartmentService;
 ...
 * @see Department
 */
@RestController("HoursAccOnt1.DepartmentController")
@Api(value = "DepartmentController", description = "Exposes APIs to work with Department resource.")
@RequestMapping("/HoursAccOnt1/Department")
public class DepartmentController {

    private static final Logger LOGGER = LoggerFactory.getLogger(DepartmentController.class);

    @Autowired
	@Qualifier("HoursAccOnt1.DepartmentService")
    ...
    @RequestMapping(value="/{id:.+}/hoursLoggeds", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the hoursLoggeds instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<HoursLogged> findAssociatedHoursLoggeds(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated hoursLoggeds");
        return departmentService.findAssociatedHoursLoggeds(id, pageable);
    }
