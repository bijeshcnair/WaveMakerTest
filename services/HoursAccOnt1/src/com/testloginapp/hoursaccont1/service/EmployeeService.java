...
public interface EmployeeService {
    ...
    /*
     * Returns the associated hoursLoggedsForEmplId for given Employee id.
     *
     * @param emplId value of emplId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated HoursLogged instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<HoursLogged> findAssociatedHoursLoggedsForEmplId(Integer emplId, Pageable pageable);

    /*
     * Returns the associated hoursLoggedsForManagerId for given Employee id.
     *
     * @param emplId value of emplId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated HoursLogged instances.
     ...
     * @see Page
     */
    Page<HoursLogged> findAssociatedHoursLoggedsForManagerId(Integer emplId, Pageable pageable);
