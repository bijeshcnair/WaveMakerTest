...
/**
 * Specifies methods used to obtain and modify Login related information
 * which is stored in the database.
 */
@Repository("HoursAccOnt1.LoginDao")
public class LoginDao extends WMGenericDaoImpl<Login, Integer> {
