...
/**
 * Specifies methods used to obtain and modify HoursLogged related information
 * which is stored in the database.
 */
@Repository("HoursAccOnt1.HoursLoggedDao")
public class HoursLoggedDao extends WMGenericDaoImpl<HoursLogged, Integer> {
